...
public class Client extends AbstractEntity
{
    ...
    public String toString() {
        return invokedynamic(makeConcatWithConstants:(Ljava/lang/String;Ljava/lang/String;Lcom/bouali/gestiondestock/model/Adresse;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;Ljava/util/List;)Ljava/lang/String;, this.getNom(), this.getPrenom(), this.getAdresse(), this.getPhoto(), this.getMail(), this.getNumTel(), this.getIdEntreprise(), this.getCommandeClients());
    }
    
    public Client() {
    }
    
    public Client(final String nom, final String prenom, final Adresse adresse, final String photo, final String mail, final String numTel, final Integer idEntreprise, final List<CommandeClient> commandeClients) {
        this.nom = nom;
        this.prenom = prenom;
        this.adresse = adresse;
        this.photo = photo;
